...
evidence re-fetch from RAG,



constrained re-scoring,
...
Validate with evidence/citations.



Detect conflicts and bias.



Re-retrieve missing evidence.



Re-score under constraints.



Debate and arbitrate.
...
Frontend: Streamlit (or Next.js later), Plotly/Pandas for dashboards.
